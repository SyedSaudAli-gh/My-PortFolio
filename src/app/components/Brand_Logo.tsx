...
function Brand_Logo() {
    ...
    // ✅ Determine logo based on resolved theme
        ...
        return (
            <div>
                <Link className="flex items-center group" href="/">
                    ...
                    <span className="font-lobster text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-foreground truncate max-w-[140px] sm:max-w-[180px] md:max-w-[220px] lg:max-w-none">
                        SYED SAUD ALI
                    </span>
                </Link>
            </div>
        ...
        <div>
            ...
            >
                ...
                <div className="relative mr-2 sm:mr-3 transform-gpu">
                    ...
                    <div
                        className={`absolute transition-all duration-700 ease-in-out ${logoHovered ? "inset-[-10px] sm:inset-[-12px] opacity-100" : "inset-[-8px] sm:inset-[-10px] opacity-0"
                            }`}
                    >
                ...
                {/* Brand name with animated gradient - Responsive text */}
                <span
                    className="
                        font-lobster 
                        ...
                        animate-text-glow
                        truncate
                        max-w-[140px] sm:max-w-[180px] md:max-w-[220px] lg:max-w-none
                    "
                >
                    SYED SAUD ALI
                </span>
